/* LE TEXTE DE CHAQUE PHRASE — pour le mode essai (12 septembre 2026)

   Mickaël : « il faudrait que je puisse voir le texte que tu mets à chaque
   fois. » On ne juge pas une phrase entendue une seule fois, au vol, pendant
   qu'on regarde autre chose bouger. Écrite, elle se relit.

   ⚠️ ENGENDRÉ depuis le script de fabrication des voix, qui fait foi. Ne pas
   retoucher à la main : sinon l'écrit et l'entendu divergeraient, ce qui
   serait pire que pas de texte du tout. */
window.TEXTES_VISITE = {
  ...
  '02b-mises-a-jour':
    'Un mot sur les mises à jour. Le medley, lui, est terminé : ce que tu as sous les yeux, c\'est ce qu\'on chantera. Ce qui va continuer de grandir, c\'est l\'application — et surtout la mise en scène. Elle est déjà écrite, tu la retrouves bloc par bloc, et l\'atelier te la rappelle pendant que tu chantes. Mais ce sont les vidéos qui vont vraiment t\'aider, et elles arrivent. Alors le bouton Mise à jour, juste en dessous, va chercher la dernière version : il n\'y a jamais rien à réinstaller. Si tu appuies et que rien ne semble changer, ferme complètement l\'application, puis rouvre-la — elle met parfois un instant à s\'installer. Et quand Mickaël vous préviendra sur WhatsApp qu\'il y a du nouveau, pense à le faire. C\'est comme ça que vous travaillerez tous sur la même version.',
  '02c-merci':
    'Ah, super. Tu l\'as fait. Merci — Mickaël va le voir tout de suite, et ça lui enlève une inquiétude. Voilà, c\'était la seule chose qu\'on te demandait. On peut continuer tranquillement.',
  '02d-plus-tard':
    'Très bien, tu as fait ton choix. Le bouton reste là, tout en haut de l\'accueil, et il restera rouge tant que tu ne l\'auras pas touché. Essaie quand même de le faire aujourd\'hui, si tu peux : tant que Mickaël ne sait pas que l\'application s\'ouvre chez chacun de vous, il ne peut rien vous envoyer — ni les mises à jour, ni les vidéos de la mise en scène. C\'est un appui, et après on est tranquilles. On continue.',
  '02e-les-infos':
